...
Característica: Realizar el llenado del carrito de compras
  ...
  Esquema del escenario: Agregar articulos al carrito de compras como cliente nuevo
    ...
    Y se registre con sus nuevas credenciales usuario hector202356789029 y constraseña 123456789
    Cuando se haga login con sus credenciales usuario hector202356789029 y constraseña 123456789
